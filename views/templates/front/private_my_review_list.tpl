  ...
  {foreach from=$reviewsData.reviews.reviews item=review}
    ...
    <div class="revws-review-with-product">
      ...
      <div class="revws-review-wrapper">
        ...
        {include file="module:revws/views/templates/hook/private_review_list_item.tpl" review=$review shopName=$reviewsData.shopName shape=$reviewsData.theme.shape criteria=$reviewsData.criteria displayCriteria=$reviewsData.preferences.displayCriteria}
      </div>
    </div>
  {/foreach}
  {else}

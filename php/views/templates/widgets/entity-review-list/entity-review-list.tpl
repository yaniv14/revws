        ...
        {if !$hasReviewed}
            {if $canReview}
              <div class="form-group">
                <a class="pointer text-berez-blue underline" data-revws-entity-type="{$entityType}" data-revws-create-trigger="{$entityId}">
            ...
            {else}
                {if $visitor.type === 'guest'}
                  <div class="form-group">
                    <a class="pointer text-berez-blue underline" href="{$reviewsData.loginUrl}" rel="nofollow">
